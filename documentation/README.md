...
| [server-ca](#server-ca) | string |  |  |:large_blue_circle:|:large_blue_circle:|:large_blue_circle:|
...
| [ssl-redirect-port](#https) | number | 443 | tls-secret |:large_blue_circle:|:large_blue_circle:|:white_circle:|
